...
insert into pelicula values (2, "CARTELERA", "ACCION", "Dragon Ball: Super Hero", 3.5, "Olivia Rodrigo, Brad Pitt, Jennifer Lawrence", "La malvada organización Red Ribbon Army se reforma con nuevos y más poderosos androides, Gamma {1} y Gamma {2} para buscar venganza.", "https://dragonbll.jpg", "https://youtube//SxtZ8fU.com");
