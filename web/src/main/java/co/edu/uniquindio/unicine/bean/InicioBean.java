...
public class InicioBean implements Serializable {
    ...
    public void inicializar(){
        ...
        try {
            ...
            if(codigoCiudad!=null && !codigoCiudad.isEmpty()) {
                ciudad = adminServicio.obtenerCiudad(Integer.parseInt(codigoCiudad));
    ...
    public void seleccionarCiudad(){
        if(ciudad!=null) {
            try {
                FacesContext.getCurrentInstance().getExternalContext().redirect("index.xhtml?ciudad_id="+ciudad.getCodigo());
